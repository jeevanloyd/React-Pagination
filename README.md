# Code Challenge
Json Server to exchange data to/from a web server. I used Json Server to demostrate the data fetching Using "Fetch" with Async and Await to make network requests to the server and load new information.
